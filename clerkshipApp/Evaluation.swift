                ...
                VStack(spacing: 0) {
                    ...
                    ScrollView {
                        VStack(alignment: .leading, spacing: 30) {
                            ...
                            QuestionView(question: "Patient assessment ~ Can student take patient history?", selection: $question1, required: true)
                            QuestionView(question: "Physical examination ~ Is student able to perform physical exam with appropriate technique and respect for patient?", selection: $question2, required: true)
                            QuestionView(question: "Clinical reasoning ~ Does the student demonstrate ability to remember patient history and exam to formulate a diagnosis and defend it?", selection: $question3, required: true)
                            QuestionView(question: "Case presentation ~ Can student present case accurately to preceptor?", selection: $question4, required: true)
                            QuestionView(question: "Documentation ~ Is student's documentation clear and comprehensive?", selection: $question5, required: true)
...
struct QuestionView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            // Question text
            if(required){
                Text(question).foregroundColor(.white) + Text(" *").foregroundColor(.red)
            }else{
